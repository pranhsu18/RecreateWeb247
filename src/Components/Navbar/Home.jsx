    ...
    <div className="home_page">
      <div className="hero-section">
        <div className="hero-text">
          ...
          <p>
            Global Enterprise Solutions delivers end-to-end technology and business services including ERP, software outsourcing, multimedia design, web development, hosting, AI analytics, content creation, video editing, and teleservices—empowering organizations with innovative, reliable, and impactful solutions.
          </p>
        </div>
